...
export type { SlackClient, SlackClientFactory, SlackMessageEvent } from './slack.js';
export { createWhatsAppAdapter } from './whatsapp.js';
export type { WhatsAppConnection, WhatsAppInboundMessage } from './whatsapp.js';
export { createSignalAdapter } from './signal.js';
export type { SignalConnection, SignalInboundMessage } from './signal.js';
